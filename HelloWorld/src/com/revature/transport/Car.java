...
public class Car extends Vehicle implements Steerable, Comparable<Car>, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4490052115838480245L;
	...
	public void move() throws MaintenenceException {
		...
		if(this.getMilesSinceOilChange() >= recommendedMiBtwnOilChanges) {
	...
	public int compareTo(Car o) {
		return this.model.compareTo(o.getModel())+(this.yearManufactured-o.getYearManufactured()); 
